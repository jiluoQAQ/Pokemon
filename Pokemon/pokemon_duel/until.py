...
async def get_shanghai_pt_cs(*args,**kwargs):
    jineng = kwargs['jineng']
    myinfo = kwargs['myinfo']
    diinfo = kwargs['diinfo']
    myzhuangtai = kwargs['myzhuangtai']
    dizhuangtai = kwargs['dizhuangtai']
    changdi = kwargs['changdi']
    ztname = args[0]
    zt_jl = args[1]
    if len(args) == 3:
        zt_hh = args[2]
...
#无加成命中要害伤害技能
def get_shanghai_pt_yh(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
def get_shanghai_pt_bh(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,index):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#会对自身造成伤害的技能
def get_shanghai_pt_fs(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#会对自身回复血量的技能
def get_shanghai_pt_xh(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,xh_bl):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#附加异常状态伤害技能  
def get_shanghai_zt(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,ztname,zt_jl,zt_hh = 99):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#附加异常状态伤害技能  
def get_shanghai_zt_my(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,ztname,zt_jl,zt_hh = 99):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#我方伤害技能对我方属性提升/降低效果
def up_shuxshanghai_my(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,sxinfo,lvinfo,typeinfo,bh_jl = 20):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
...
#我方伤害技能对敌方属性提升/降低效果
def dowm_shuxshanghai_di(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,sxinfo,lvinfo,typeinfo,bh_jl = 20):
    #0NAME,1属性,2LV,3HP,4ATK,5DEF,6SP.ATK,7SP.DEF,8SPD,9攻击等级,10防御等级,11特攻等级,12特防等级,13速度等级,14要害等级,15闪避等级,16命中等级,17剩余血量
    jinenginfo = JINENG_LIST[jineng]
    ...
    if diinfo[17]>0:
        ...
        if suiji < int(bh_jl):
            ...
            for i in range(0,updatesx_num):
                ...
                uplevel = lvlist[i]
                uptype = typelist[i]
                mesg, diinfo = update_shux_info(diinfo,sxname,uplevel,uptype)
                mes = mes + '\n' + mesg
        mes = mes + f'\n{diinfo[0]}剩余血量{diinfo[17]}'
    else:
        mes = mes + f'\n{diinfo[0]}失去了战斗能力'
...
# 我方变化类技能对我方的属性提升
def up_shux_info_my(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,sxinfo,lvinfo,typeinfo):
    jinenginfo = JINENG_LIST[jineng]
    sxlist = re.split(',', sxinfo)
    lvlist = re.split(',', lvinfo)
    typelist = re.split(',', typeinfo)
...
# 我方变化类技能对地方的附加状态
def give_info_di(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,ztname,hh_num = 5):
    jinenginfo = JINENG_LIST[jineng]
...
def changdi_change(jineng,myinfo,diinfo,myzhuangtai,dizhuangtai,changdi,tqname):
    jinenginfo = JINENG_LIST[jineng]
    changdi[0][0] = tqname
    changdi[0][1] = 5
